"""
Django settings for red_glade_42769 project.
...
ROOT_URLCONF = 'red_glade_42769.urls'
...
WSGI_APPLICATION = 'red_glade_42769.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_glade_42769 API",
    "DESCRIPTION": "API documentation for red_glade_42769 App",
    "VERSION": "v1",
}
